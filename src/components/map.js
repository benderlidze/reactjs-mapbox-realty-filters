...
class Map extends React.Component {
    ...
    componentDidUpdate(prevProps) {
      ...
      if (!_.isEqual(this.props.range, prevProps.range)) {
        ...
        const data = this.props.mainData.features.filter(i => i.properties.price >= this.props.range[0] && i.properties.price <= this.props.range[1])
        console.log('', data);

        this.map.getSource('realty').setData({
